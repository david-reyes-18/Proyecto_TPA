...
from infraestructura.config import FRAME_ANCHO, FRAME_ALTO, ESCALA_GLOB, ESCALA_JUGADOR
from dominio.entidades.jugador.reproductor_sonido_pasos  import ReproductorSonidosPasos
...
from dominio.entidades.jugador.renderizador import Renderizador
