...
from presentacion.escenas.escena_inventario import EscenaInventario
from presentacion.escenas.escena_confirmar_salida import EscenaConfirmarSalida
...
class EscenaJuego(EscenaBase):
        ...
        for evento in eventos:
            if evento.type == pygame.KEYDOWN:
                ...
                # Si preciona C se abrirá la configuración
                    ...
                    from presentacion.escenas.escena_config import EscenaConfig
    ...
    def _abrir_escena(self, tipo: str):
        ...
        if tipo == "laptop":
            from presentacion.escenas.escena_correo import EscenaCorreo
            self.juego.manejador_escenas.cambiar_escena(EscenaCorreo(self.juego))
            
        # Si es el taller se abré la escena del taller
        elif tipo == "taller":
            from presentacion.escenas.escena_taller import EscenaTaller
